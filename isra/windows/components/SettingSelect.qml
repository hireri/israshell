...
SettingRow {
    ...
    Control {
        ...
        property var filteredOptions: root.options
        ...
        Connections {
            ...
            function onCurrentValueChanged() {
                var selectedOpt = root.options.find(function(o) { return o.value === root.currentValue; });
                combo.selectedLabel = selectedOpt ? selectedOpt.label : "";
                textField.text = combo.selectedLabel;
            }
            function onOptionsChanged() {
                combo.filteredOptions = root.options;
                var selectedOpt = root.options.find(function(o) { return o.value === root.currentValue; });
                combo.selectedLabel = selectedOpt ? selectedOpt.label : "";
                textField.text = combo.selectedLabel;
        ...
        function filterOptions(query) {
            if (!query) {
                ...
                filteredOptions = root.options.filter(function(o) {
        ...
        function revertOrApply() {
            ...
            var exactMatch = root.options.find(function(o) { return o.label.toLowerCase() === typed; });
        ...
        Popup {
            ...
            function reposition() {
                ...
                var calculatedHeight = combo.filteredOptions.length === 0 
                    ? 40 
                    : (combo.filteredOptions.length * itemHeight);
