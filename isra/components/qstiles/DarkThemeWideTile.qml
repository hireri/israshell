...
Item {
    ...
    readonly property string sublabel: Config.nightLight.autoDarkMode
        ? ((root._on ? "Light at " : "Dark at ") + _formatTime(root._on ? Config.nightLight.sunrise : Config.nightLight.sunset))
        : ""
        ...
        Rectangle {
            ...
            Loader {
                ...
                Binding {
                    ...
                    property: "filled"
                    value: root._on
                    when: iconLoader.status === Loader.Ready && iconLoader.item && iconLoader.item.hasOwnProperty("filled")
                }
            }
